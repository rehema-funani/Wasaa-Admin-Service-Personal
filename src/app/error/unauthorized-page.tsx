...
const UnauthorizedPage: React.FC = () => {
    ...
    return (
        <div
            ref={containerRef}
            className="min-h-screen w-full flex items-center justify-center perspective-1000 bg-gradient-to-br from-slate-50 via-primary-50/30 to-primary-50 p-4 overflow-hidden"
        >
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute top-0 -right-20 w-96 h-96 rounded-full bg-gradient-to-br from-primary-200/30 to-primary-300/20 blur-3xl animate-float-slow" />
                <div className="absolute top-1/3 -left-20 w-80 h-80 rounded-full bg-gradient-to-tr from-primary-200/20 to-violet-200/20 blur-3xl animate-float-slower" />
                <div className="absolute -bottom-40 right-1/3 w-96 h-96 rounded-full bg-gradient-to-tr from-cyan-100/20 to-primary-200/30 blur-3xl animate-float" />

                <div className="absolute top-20 right-20 w-12 h-12 rounded-lg bg-gradient-to-br from-primary-400/10 to-primary-400/10 backdrop-blur-md rotate-12 animate-spin-very-slow border border-white/20" />
                <div className="absolute bottom-20 left-20 w-16 h-16 rounded-full bg-gradient-to-br from-primary-300/10 to-violet-400/10 backdrop-blur-md animate-float-slow border border-white/20" />
                <div className="absolute top-1/3 right-1/3 w-10 h-10 rounded-md bg-gradient-to-br from-cyan-300/10 to-primary-400/10 backdrop-blur-md -rotate-12 animate-float border border-white/20" />
            </div>

            <div className="absolute top-1/4 left-1/4 w-2 h-2 rounded-full bg-primary-400/70 blur-sm animate-pulse" />
            <div className="absolute top-3/4 left-2/3 w-2 h-2 rounded-full bg-primary-400/70 blur-sm animate-pulse" />
            <div className="absolute top-1/3 right-1/4 w-1.5 h-1.5 rounded-full bg-violet-400/70 blur-sm animate-pulse-slow" />

            <div className="absolute top-0 left-1/2 w-1/3 h-screen bg-gradient-to-b from-primary-400/5 via-primary-400/5 to-transparent transform -translate-x-1/2 rotate-15 blur-3xl" />
            ...
            >
                <div className="backdrop-blur-xl bg-white/60 rounded-3xl shadow-2xl border border-white/40 overflow-hidden transition-all duration-300 hover:shadow-primary-200/20">
                    <div className="relative h-48 bg-gradient-to-r from-primary-600/95 via-primary-600/95 to-violet-600/95 flex items-center justify-center overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col items-center justify-center">
                            <div className="w-24 h-24 rounded-3xl bg-white/20 backdrop-blur-lg flex items-center justify-center border border-white/30 shadow-lg animate-float-subtle">
                                ...
                                <div className="absolute inset-0 rounded-3xl bg-primary-400/30 filter blur-xl opacity-70 animate-pulse-slow" />
                            </div>
                    ...
                    <div className="p-8">
                        ...
                        <div className="space-y-3 mb-8">
                            <div className="rounded-2xl overflow-hidden border border-primary-100 shadow-sm transition-all duration-300 hover:shadow-md">
                                <button
                                    onClick={() => toggleSection('access')}
                                    className="w-full bg-white p-4 flex items-center justify-between text-left hover:bg-primary-50/50 transition-colors duration-200"
                                >
                                    ...
                                    <ChevronRight
                                        size={18}
                                        className={`text-primary-400 transition-transform duration-300 ${expandedSection === 'access' ? 'rotate-90' : ''}`}
                                    />
                                </button>

                                <div
                                    className={`bg-primary-50/70 overflow-hidden transition-all duration-300 ease-in-out ${expandedSection === 'access' ? 'max-h-40 p-4' : 'max-h-0'
                                        }`}
                                >
                            ...
                            <div className="rounded-2xl overflow-hidden border border-primary-100 shadow-sm transition-all duration-300 hover:shadow-md">
                                ...
                                >
                                    ...
                                    <ChevronRight
                                        size={18}
                                        className={`text-primary-400 transition-transform duration-300 ${expandedSection === 'system' ? 'rotate-90' : ''}`}
                                    />
                                </button>

                                <div
                                    className={`bg-primary-50/70 overflow-hidden transition-all duration-300 ease-in-out ${expandedSection === 'system' ? 'max-h-40 p-4' : 'max-h-0'
                                        }`}
                                >
                                    <p className="text-sm text-primary-700">
                        ...
                        <div className="space-x-3 flex">
                            <button
                                onClick={() => navigate('/')}
                                className="action-button w-full py-2 text-[13px] px-4 rounded-xl bg-gradient-to-r from-primary-500 via-primary-500 to-primary-600 text-white font-medium shadow-lg shadow-primary-500/20 hover:shadow-xl hover:shadow-primary-500/30 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 flex items-center justify-center opacity-0 transform translate-y-4"
                            >
                                <Home size={18} className="mr-2 h-4 w-4" />
                                <span>Return to Dashboard</span>
                                <div className="absolute inset-0 rounded-2xl bg-primary-400/20 filter blur-md opacity-0 hover:opacity-100 transition-opacity duration-300" />
                            </button>
                            ...
                            <button
                                ...
                                className="action-button w-full py-2 text-[13px] px-4 rounded-xl bg-gradient-to-r from-primary-50 to-primary-50 border border-primary-100 text-primary-700 font-medium hover:bg-gradient-to-r hover:from-primary-100/50 hover:to-primary-100/50 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-sm flex items-center justify-center opacity-0 transform translate-y-4"
                            >
                ...
                <div className="absolute top-24 -left-6 w-16 h-16 rounded-full bg-gradient-to-r from-primary-400 to-primary-400 blur-xl opacity-50 animate-pulse-slow" />
                <div className="absolute -bottom-4 right-10 w-20 h-20 rounded-full bg-gradient-to-r from-primary-300 to-purple-400 blur-xl opacity-40 animate-float-slow" />
                <div className="absolute -bottom-2 left-20 w-12 h-12 rounded-full bg-gradient-to-r from-cyan-300 to-primary-400 blur-xl opacity-30 animate-float" />
            </div>
