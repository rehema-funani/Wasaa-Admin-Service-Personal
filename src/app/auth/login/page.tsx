            ...
            <div className="relative z-10">
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-xs font-medium px-2 py-1 bg-teal-50 text-teal-500 rounded-full">+24%</span>
                </div>
                <div className="h-16 flex items-end space-x-1">
                  {[40, 25, 60, 42, 55, 85, 70].map((height, i) => (
                    <motion.div
                      ...
                      transition={{ delay: i * 0.1 + 0.5, duration: 0.7, type: "spring" }}
                      className="flex-1 rounded-t-md bg-gradient-to-t from-teal-500 to-primary-500"
                    />
                  ))}
                </div>
              ...
              >
                ...
                <div className="h-1.5 w-full bg-gray-100 rounded-full mb-2">
                  <motion.div
                    ...
                    className="h-1.5 bg-gradient-to-r from-teal-500 to-primary-500 rounded-full"
                  />
                </div>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="relative">
              <input
                ...
                placeholder=" "
                required
                className="block w-full px-4 py-3.5 text-gray-700 border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200 peer"
              />
              <label
                htmlFor="email"
                className="absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white px-2 peer-focus:px-2 peer-focus:text-teal-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-3"
              >
                Email Address
              </label>
            </div>
            ...
            <div className="flex justify-end">
              <a href="#" className="text-sm font-medium text-teal-500 hover:text-teal-600 transition-colors">
                Forgot password?
              </a>
            </div>
            ...
            <div className="flex items-center justify-between pt-1">
              <div className="flex items-center">
                <div className="relative inline-flex items-center">
                  <input
                    ...
                    className="h-4 w-4 rounded-sm border-gray-300 text-teal-500 focus:ring-teal-500 focus:ring-offset-0"
                  />
                  <label htmlFor="remember-device" className="ml-2 text-sm text-gray-600">
                    Remember me
                  </label>
                </div>
              </div>
              <div className="flex items-center space-x-2">
                <motion.div
                  ...
                  className="w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 hover:bg-gray-50 cursor-pointer transition-all"
                >
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-500">
              No account? <a href="#" className="font-medium text-teal-500 hover:text-teal-600 transition-colors">Request access</a>
            </p>
          </div>
