        ...
        >
          <div className="relative flex items-center justify-center w-20 h-20">
            <motion.div
              ...
              style={{
                background: "conic-gradient(from 0deg, rgba(59, 130, 246, 0), rgba(59, 130, 246, 1))"
              }}
              animate={{ rotate: 360 }}
      ...
      >
        <div className="flex items-center space-x-3">
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
            className={`flex items-center justify-center w-10 h-10 rounded-full ${theme === "light" ? "bg-blue-50" : "bg-blue-900/50"
              }`}
          >
            <Settings size={20} className={theme === "light" ? "text-blue-600" : "text-blue-300"} />
          </motion.div>
          <h1 className={`text-base font-semibold ${theme === "light" ? "text-gray-800" : "text-white"}`}>
            Settings
          </h1>
        </div>
        ...
        >
          <div className="flex items-center space-x-4 mb-2">
            <motion.div
              ...
              className={`flex items-center justify-center w-14 h-14 rounded-2xl ${theme === "light" ? "bg-blue-50" : "bg-blue-900/50"
                } shadow-lg shadow-blue-500/10`}
            >
              <Settings size={26} className={theme === "light" ? "text-blue-600" : "text-blue-300"} />
            </motion.div>
            <div>
              <motion.h1
              ...
              <p className={`text-[14px] mt-1 ${theme === "light" ? "text-gray-500" : "text-gray-400"}`}>
