  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 relative z-10">
      ...
      >
        {/* Navigation Card */}
        <motion.div
          className={`backdrop-blur-xl rounded-2xl shadow-md overflow-hidden border ${currentTheme.cardBorder} bg-gradient-to-br ${currentTheme.cardBg}`}
          initial="rest"
          whileHover="hover"
          variants={cardHover}
        >
        ...
        <motion.div
          ...
          variants={cardHover}
        >
          <h3 className={`text-[13px] font-semibold ${theme === "light" ? "text-blue-700" : "text-blue-300"} mb-2`}>
            System Status
          </h3>
          <div className={`text-xs ${theme === "light" ? "text-gray-600" : "text-gray-300"} space-y-2`}>
            ...
            <div className={`h-1.5 w-full mt-2 rounded-full overflow-hidden ${theme === "light" ? "bg-gray-200" : "bg-gray-700"}`}>
              <motion.div
      ...
      >
        <motion.div
          className={`backdrop-blur-xl rounded-2xl shadow-md border ${currentTheme.cardBorder} bg-gradient-to-br ${currentTheme.cardBg} p-6 lg:p-8`}
          initial="rest"
          whileHover="hover"
          variants={cardHover}
        >
