...
const AMLComplianceDashboard: React.FC = () => {
    ...
    const filteredAlerts = alerts.filter(alert => {
        ...
        const matchesRisk = riskFilter === 'all' || alert.RiskLevel.name === riskFilter;
    ...
    return (
        <div className="min-h-screen bg-transparent font-['SF Pro Display', 'Inter', sans-serif]">
            <div className="w-full mx-auto">
                <div className="mb-6">
                    <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
                        <div>
                            <h1 className="text-2xl font-bold text-gray-800 tracking-tight">AML & Compliance Monitoring</h1>
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                className="flex items-center gap-1.5 px-4 py-2.5 bg-white border border-gray-200 text-gray-700 rounded-xl shadow-sm hover:bg-gray-50 transition-all text-sm"
                            ...
                            <button
                                className="flex items-center gap-1.5 px-4 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl shadow-sm hover:from-blue-700 hover:to-indigo-700 transition-all text-sm"
                            >
                                <Download size={16} />
                    ...
                    {successMessage && (
                        <div className="mb-5 flex items-center gap-2 p-4 bg-green-50 rounded-xl border border-green-100 text-green-700 animate-fadeIn">
                    ...
                    {errorMessage && (
                        <div className="mb-5 flex items-center gap-2 p-4 bg-red-50 rounded-xl border border-red-100 text-red-700 animate-fadeIn">
                    ...
                    {/* Tab Navigation */}
                    <div className="flex overflow-x-auto scrollbar-hide mb-8 bg-gray-100 rounded-xl p-1">
                        <button
                            className={`flex items-center px-4 py-2.5 text-sm font-medium rounded-lg transition-all ${activeTab === 'dashboard'
                        ...
                        <button
                            className={`flex items-center px-4 py-2.5 text-sm font-medium rounded-lg transition-all ${activeTab === 'blacklist'
                                ? 'bg-white text-gray-800 shadow-sm'
                                : 'text-gray-600 hover:text-gray-800 hover:bg-gray-50'
                                }`}
                        ...
                        <button
                            className={`flex items-center px-4 py-2.5 text-sm font-medium rounded-lg transition-all ${activeTab === 'activity'
                                ? 'bg-white text-gray-800 shadow-sm'
                                : 'text-gray-600 hover:text-gray-800 hover:bg-gray-50'
                                }`}
                        ...
                        <button
                            className={`flex items-center px-4 py-2.5 text-sm font-medium rounded-lg transition-all ${activeTab === 'rules'
                                ? 'bg-white text-gray-800 shadow-sm'
                                : 'text-gray-600 hover:text-gray-800 hover:bg-gray-50'
                                }`}
