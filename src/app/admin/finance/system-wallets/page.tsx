...
const SystemWalletsPage: React.FC = () => {
    ...
    const getWalletIcon = (type: string) => {
        switch (type) {
            ...
            case 'refund':
                return <RefreshCw className="w-5 h-5 text-warning-600 dark:text-warning-400" />;
            case 'float':
                return <BanknoteIcon className="w-5 h-5 text-primary-600 dark:text-primary-400" />;
            case 'promotions':
                return <Sparkles className="w-5 h-5 text-success-600 dark:text-success-400" />;
            default:
    ...
    const getWalletAccentColor = (type: string) => {
        switch (type) {
            ...
            case 'refund':
                return 'border-l-warning-500 dark:border-l-warning-600';
            case 'float':
                return 'border-l-primary-500 dark:border-l-primary-600';
            case 'promotions':
                return 'border-l-success-500 dark:border-l-success-600';
            default:
            ...
            <div className="w-full mx-auto">
                <div className="mb-6">
                    <div className="flex flex-col md:flex-row md:items-center justify-between mb-5 gap-4">
                        <div>
                            ...
                            <p className="text-neutral-500 dark:text-neutral-400 text-sm mt-1">Manage system wallets for commissions, reversals, settlements, and transaction processing</p>
                        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-8">
                    {isLoading ? (
                        ...
                        <div className="col-span-2 bg-white dark:bg-dark-elevated rounded-lg shadow-card dark:shadow-dark-md border border-neutral-200 dark:border-dark-border p-8 text-center">
                                ...
                                <div className="p-5">
                                    ...
                                    <div className="mt-5 pt-3 border-t border-neutral-100 dark:border-dark-border flex gap-2">
                                        <button
                                            ...
                                            className="flex-1 text-xs py-2 px-3 rounded-lg bg-primary-50 dark:bg-primary-900/20 text-primary-700 dark:text-primary-400 hover:bg-primary-100 dark:hover:bg-primary-900/30 font-medium transition-colors"
                                        >
                                            Top Up
                                        </button>
                                        <button
