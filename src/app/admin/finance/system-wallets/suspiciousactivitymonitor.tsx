...
const SuspiciousActivityMonitor: React.FC = () => {
  ...
  const mockActivities: SuspiciousActivity[] = [
    {
      ...
      status: "detected",
      description:
        "Multiple high-value transactions in short time period (15 transactions in 20 minutes)",
    ...
    },
    {
      ...
      status: "under_review",
      description:
        "Login from new location 5,000km from previous login within 2 hours",
    ...
    },
    {
      ...
      status: "escalated",
      description:
        "Circular funds movement through 3 connected accounts within 24 hours",
    ...
    },
    {
      ...
      resolution:
        "Verified legitimate purchase of business equipment with supporting documentation",
    ...
    },
    {
      ...
      description:
        "Consistent transactions at unusual hours (2AM-4AM) for past 5 days",
      detectedAt: "2025-05-16T13:10:00Z",
      assignedTo: "Security Officer",
      reviewedAt: "2025-05-16T15:20:00Z",
      resolvedAt: "2025-05-16T17:40:00Z",
      resolution:
        "User confirmed night shift worker with legitimate transaction pattern",
    ...
    },
    {
      ...
      status: "under_review",
      description:
        "Account inactive for 6 months, then 15 transactions in 2 days",
  ...
  const handleStatusUpdate = (
    activityId: string,
    newStatus: SuspiciousActivity["status"],
    note: string = ""
  ) => {
    // In a real implementation, this would call an API
  ...
  const getModalTitle = () => {
    ...
    switch (modalType) {
      case "view":
        return `Suspicious Activity: ${formatActivityType(
    ...
    <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            >
              ...
              <option value="geo_location_mismatch">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-8">
        <div className="p-5 border-b border-gray-200 flex justify-between items-center">
          ...
          <button className="flex items-center gap-1.5 px-3 py-1.5 bg-primary-100 text-primary-700 rounded-lg hover:bg-primary-200 transition-colors text-sm">
            <Download size={16} />
              ...
              <tbody className="divide-y divide-gray-200">
                {filteredActivities.map((activity) => (
                  <tr key={activity.id} className="hover:bg-gray-50">
                    <td className="px-3 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <div
                            className="text-xs text-gray-500 mt-0.5 w-48 truncate"
                    ...
                    <td className="px-3 py-4 whitespace-nowrap">
                      <span
                        className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium ${getRiskLevelColor(
                          activity.riskLevel
                        )}`}
                      >
                        {getRiskLevelIcon(activity.riskLevel)}
                        {activity.riskLevel.charAt(0).toUpperCase() +
                          activity.riskLevel.slice(1)}
                      </span>
                    </td>
                    <td className="px-3 py-4 whitespace-nowrap">
                      <span
                    ...
                    <td className="px-3 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex items-center justify-end gap-1">
                        ...
                        {activity.transactionIds &&
                          activity.transactionIds.length > 0 && (
                            <button
                              className="text-primary-600 hover:text-primary-900 p-1"
      ...
      >
        {modalType === "view" && selectedActivity && activityDetails && (
          <div className="space-y-4 p-1">
              ...
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  >
                    ...
                    {selectedActivity.riskLevel.charAt(0).toUpperCase() +
                      selectedActivity.riskLevel.slice(1)}{" "}
                    Risk
                  </span>
                  <span
                    className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(
                ...
                <div className="bg-gray-50 p-3 rounded-lg">
                  <div className="grid grid-cols-2 gap-y-2 text-sm">
                    ...
                    <div className="text-gray-800">
                      {activityDetails.deviceType}
                    </div>

                    <div className="text-gray-500">Browser:</div>
                    <div className="text-gray-800">
                      {activityDetails.browser}
                    </div>

                    <div className="text-gray-500">OS:</div>
                    <div className="text-gray-800">
                      {activityDetails.operatingSystem}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-3 rounded-lg">
                  <div className="grid grid-cols-2 gap-y-2 text-sm">
                    ...
                    <div className="text-gray-800">
                      {activityDetails.ipAddressDetails.ip}
                    </div>

                    <div className="text-gray-500">Location:</div>
                    <div className="text-gray-800">
                      {activityDetails.ipAddressDetails.city},{" "}
                      {activityDetails.ipAddressDetails.country}
                    </div>

                    <div className="text-gray-500">ISP:</div>
                    <div className="text-gray-800">
                      {activityDetails.ipAddressDetails.isp}
                    </div>

                    <div className="text-gray-500">Proxy/VPN:</div>
                    <div className="text-gray-800">
                      {activityDetails.ipAddressDetails.proxy ||
                      activityDetails.ipAddressDetails.vpn ||
                      activityDetails.ipAddressDetails.tor ? (
            ...
            {selectedActivity.transactionIds &&
              selectedActivity.transactionIds.length > 0 && (
                <div>
                  <h3 className="text-sm font-medium text-gray-700 mb-2">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                          {activityDetails.transactionDetails?.map((tx) => (
                            <tr key={tx.id} className="hover:bg-gray-50">
                              <td className="px-3 py-2 whitespace-nowrap text-xs text-primary-600 font-medium">
                                {tx.id}
                              </td>
            ...
            {selectedActivity.relatedUsers &&
              selectedActivity.relatedUsers.length > 0 && (
                <div>
                  <h3 className="text-sm font-medium text-gray-700 mb-2">
                    Related Users
                  </h3>
                ...
                {selectedActivity.assignedTo && selectedActivity.reviewedAt && (
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500 mt-0.5">
                        {formatDate(selectedActivity.reviewedAt)} by{" "}
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500 mt-0.5">
                        {selectedActivity.reviewedAt
                          ? formatDate(selectedActivity.reviewedAt)
                          : "N/A"}
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-700">
                    You are updating the status of a suspicious activity for{" "}
                    <strong>{selectedActivity.userName}</strong>. This action
            ...
            <div>
              ...
              <div className="space-y-2">
                {selectedActivity.status === "detected" && (
                  <button
                    onClick={() =>
                      handleStatusUpdate(selectedActivity.id, "under_review")
                    }
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="text-left">
                        ...
                        <div className="text-xs text-gray-500">
                          Begin investigating this activity
                        </div>
                      </div>
                    </div>
                ...
                {(selectedActivity.status === "detected" ||
                  ...
                  <button
                    onClick={() =>
                      handleStatusUpdate(selectedActivity.id, "escalated")
                    }
                    className="w-full flex items-center justify-between p-3 bg-white border border-gray-200 rounded-lg hover:bg-gray-50"
                  >
                    <div className="flex items-center">
                ...
                {(selectedActivity.status === "detected" ||
                  ...
                  <>
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <div className="text-left">
                          ...
                          <div className="text-xs text-gray-500">
                            Activity has been addressed and resolved
                          </div>
                        </div>
                      </div>
                      <ArrowUpRight size={16} className="text-gray-400" />
                    ...
                    <button
                      onClick={() => {
                        const note = window.prompt(
                          "Please provide a reason for false positive:"
                        );
                        if (note) {
                          handleStatusUpdate(
                            selectedActivity.id,
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <div className="text-left">
                          ...
                          <div className="text-xs text-gray-500">
                            Activity was flagged incorrectly
                          </div>
                        </div>
                      </div>
                      <ArrowUpRight size={16} className="text-gray-400" />
          ...
          activityDetails && (
            <div className="space-y-4 p-1">
              ...
              <div className="flex justify-between items-center pt-4 mt-5 border-t border-gray-200">
                <button className="flex items-center gap-1.5 px-3 py-1.5 bg-primary-50 text-primary-700 rounded-lg hover:bg-primary-100 transition-colors text-sm">
                  <Download size={16} />
