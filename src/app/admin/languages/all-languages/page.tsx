...
const LanguageManager = () => {
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 px-3 py-2 border border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen font-sans">
      <div className="bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-900 border-b border-gray-100 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="flex items-center px-4 py-2 bg-blue-600 dark:bg-blue-700 text-white rounded-lg text-sm font-medium shadow-sm hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-4 hover:shadow-md transition-shadow">
            ...
            <div className="mt-4 flex items-center text-xs text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-700/50 p-2 rounded-lg">
                ...
                <div className="flex items-center space-x-1 flex-wrap">
                  {languages
                    ...
                    .map((lang) => (
                      <span
                        key={lang.id}
                        className="px-2 py-1 bg-purple-50 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 rounded-md"
                      >
                        {lang.code}
                      </span>
                    ))}
          ...
          <div className="p-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div className="relative flex-grow max-w-md w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 text-sm border border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50 dark:bg-gray-700 hover:bg-white dark:hover:bg-gray-600 transition-colors text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400"
              />
              {searchQuery && (
                <button
            ...
            <div className="flex items-center space-x-2 text-sm w-full sm:w-auto">
              <span className="text-gray-500 dark:text-gray-400 flex items-center whitespace-nowrap">
              ...
              >
                <span
                  className={`w-1.5 h-1.5 rounded-full ${
                    activeFilter === "inactive" ? "bg-white" : "bg-gray-400"
                  } mr-1.5`}
                ></span>
                Inactive
              </button>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden mb-4">
          {isLoading ? (
            ...
            <div className="p-12 text-center">
              <div className="w-16 h-16 mx-auto bg-gray-50 dark:bg-gray-700 flex items-center justify-center rounded-full mb-4">
              ...
              {searchQuery && (
                <button
                  ...
                  className="px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg text-sm font-medium hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors mx-auto"
                >
                  Clear Filters
                </button>
              )}
              {!searchQuery && (
                <button
                  onClick={handleAddNew}
                  className="px-4 py-2 bg-blue-600 text-white dark:bg-blue-700 rounded-lg text-sm font-medium hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors shadow-sm mx-auto"
                >
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-100 dark:border-gray-700">
                    <th
                      className="text-left px-6 py-3 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider cursor-pointer"
                    ...
                    <th
                      className="text-center px-6 py-3 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider cursor-pointer"
                  ...
                  {filteredLanguages.map((language, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-center">
                        {language.is_rtl ? (
                          <span className="inline-flex items-center justify-center w-6 h-6 rounded-md bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400">
                            <CheckCircle size={14} />
                          </span>
                        ) : (
                          <span className="inline-flex items-center justify-center w-6 h-6 rounded-md bg-gray-100 dark:bg-gray-700 text-gray-400 dark:text-gray-500">
                            <XCircle size={14} />
                          </span>
                        )}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-center">
                        {language.is_default ? (
                          <span className="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400">
                            Default
                          </span>
                        ) : (
                          <button
                            onClick={() => handleSetDefault(language.id)}
                            className="px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-xs rounded-md hover:bg-blue-100 dark:hover:bg-blue-900/30 hover:text-blue-700 dark:hover:text-blue-400 transition-colors"
                          >
                            Set
                          </button>
                        )}
      ...
      {showForm && (
        <div className="fixed inset-0 bg-gray-900/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div
            className="bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 max-w-md w-full overflow-hidden"
          ...
          >
            ...
            {formError && (
              <div className="px-4 py-2 bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 text-sm flex items-center">
      ...
      {deleteConfirm && (
        <div className="fixed inset-0 bg-gray-900/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div
            className="bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 max-w-sm w-full p-5"
            onClick={(e) => e.stopPropagation()}
          >
