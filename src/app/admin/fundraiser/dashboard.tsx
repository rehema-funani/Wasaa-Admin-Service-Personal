              ...
              >
                ...
                <div className="max-h-96 overflow-y-auto">
                  {notifications.map((notification) => (
                    <div
                      key={notification.id}
                      className={`p-3 border-b border-slate-100 dark:border-gray-700 hover:bg-slate-50 dark:hover:bg-gray-700 ${
        ...
        <div className="relative">
          ...
          <AnimatePresence>
            {showLanguageMenu && (
              ...
              >
                <div className="py-1">
                  {["English", "Swahili", "French", "Arabic"].map(
                    (language) => (
                      <button
                        key={language}
                        className={`w-full text-left px-4 py-2 text-sm ${
                          currentLanguage === language
                            ? "bg-slate-50 dark:bg-gray-700 text-primary-600 dark:text-primary-400"
                      ...
                      >
                        ...
                        {currentLanguage === language && (
                          <CheckCircle
                            size={14}
                            className="inline ml-2 text-primary-600 dark:text-primary-400"
                          />
                        )}
                      </button>
                    )
