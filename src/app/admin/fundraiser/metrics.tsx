...
import { format, subDays, startOfMonth, endOfMonth, subMonths, eachMonthOfInterval } from "date-fns";
import { toast } from "react-hot-toast";

// Dummy data generator for performance metrics
const generatePerformanceMetrics = () => {
  ...
  const overallMetrics = {
    ...
    conversionRate: 3.4,
    activeHours: 18.7,
    campaignCompletionTime: 42, // days
  };
  ...
  const generateMonthlyGrowth = () => {
    ...
    return last6Months.map((month, index) => {
      // Add some randomness but general upward trend
  ...
  const kpiTrends = {
    donationVolume: [
      { period: "Current Month", value: growthTrends[5].amount, change: growthTrends[5].growthRate },
      { period: "Previous Month", value: growthTrends[4].amount, change: growthTrends[4].growthRate },
      { period: "Year to Date", value: overallMetrics.totalRaised, change: 24 },
    ],
    donorAcquisition: [
      { period: "Current Month", value: growthTrends[5].uniqueDonors, change: Math.round((growthTrends[5].uniqueDonors / growthTrends[4].uniqueDonors - 1) * 100) },
      { period: "Previous Month", value: growthTrends[4].uniqueDonors, change: Math.round((growthTrends[4].uniqueDonors / growthTrends[3].uniqueDonors - 1) * 100) },
  ...
  const platformMetrics = {
    ...
    securityIncidents: 0,
    paymentProcessingTime: 2.4, // seconds
  };
...
const PerformanceMetricsPage = () => {
  ...
  type HelpTooltipKeys = 'totalRaised' | 'totalDonors' | 'successRate' | 'conversionRate';
  const [showHelpTooltip, setShowHelpTooltip] = useState<Record<HelpTooltipKeys, boolean>>({
    totalRaised: false,
    totalDonors: false,
    successRate: false,
    ...
    return (
      <div className="flex items-center">
        <div className={`flex items-center ${
          ...
          <span>{Math.abs(diff)}% {diff >= 0 ? "better" : "worse"}</span>
        </div>
      </div>
    );
  };
    ...
    <div className="p-6 w-full mx-auto max-w-[1600px]">
      ...
      {isLoading ? (
        <div className="flex items-center justify-center py-12">
          ...
          <span className="text-slate-500 dark:text-gray-400">Loading performance metrics...</span>
        </div>
      ) : metrics ? (
        <>
          {/* KPI Summary Cards */}
          ...
          >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-slate-100 dark:border-gray-700 shadow-sm">
              ...
              {showHelpTooltip.totalRaised && (
                <div className="mb-2 text-xs bg-slate-50 dark:bg-gray-700 p-2 rounded text-slate-600 dark:text-gray-300">
                  Total amount raised across all campaigns during the selected timeframe.
                </div>
              )}
              <div className="flex items-end justify-between">
                ...
                {getComparisonIndicator(metrics.kpiTrends.donationVolume[0].change)}
              </div>
              <p className="text-xs text-slate-500 dark:text-gray-400 mt-1">
                {metrics.overallMetrics.totalDonations.toLocaleString()} donations
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-slate-100 dark:border-gray-700 shadow-sm">
              ...
              {showHelpTooltip.totalDonors && (
                <div className="mb-2 text-xs bg-slate-50 dark:bg-gray-700 p-2 rounded text-slate-600 dark:text-gray-300">
                  Unique donors who have contributed to campaigns during the selected timeframe.
                </div>
              )}
              <div className="flex items-end justify-between">
                <p className="text-2xl font-light text-slate-900 dark:text-gray-100">
                ...
                {getComparisonIndicator(metrics.kpiTrends.donorAcquisition[0].change)}
              </div>
              <p className="text-xs text-slate-500 dark:text-gray-400 mt-1">
                {Math.round(metrics.overallMetrics.totalDonations / metrics.overallMetrics.totalDonors * 10) / 10} donations per donor
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-slate-100 dark:border-gray-700 shadow-sm">
              ...
              {showHelpTooltip.successRate && (
                <div className="mb-2 text-xs bg-slate-50 dark:bg-gray-700 p-2 rounded text-slate-600 dark:text-gray-300">
                  Percentage of campaigns that reach at least 80% of their funding goal.
                </div>
              )}
              <div className="flex items-end justify-between">
                <p className="text-2xl font-light text-slate-900 dark:text-gray-100">
                ...
                {getComparisonIndicator(metrics.kpiTrends.campaignSuccess[0].change)}
              </div>
              <p className="text-xs text-slate-500 dark:text-gray-400 mt-1">
                Average goal completion: {metrics.overallMetrics.averageGoalCompletion}%
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-slate-100 dark:border-gray-700 shadow-sm">
              ...
              <div className="flex items-end justify-between">
                ...
                {getComparisonIndicator(metrics.kpiTrends.conversionRate[0].change)}
              </div>
              <p className="text-xs text-slate-500 dark:text-gray-400 mt-1">
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            >
              <div className="p-4 border-b border-slate-100 dark:border-gray-700 flex justify-between items-center">
                <h2 className="text-lg font-medium text-slate-900 dark:text-white">Donation Growth Trends</h2>
                    ...
                    <div className="absolute inset-0">
                      {metrics.growthTrends.map((month, index) => (
                        <div 
                          ...
                          style={{
                            left: `${(index / metrics.growthTrends.length) * 100}%`,
                            width: `${(1 / metrics.growthTrends.length) * 100 - 2}%`,
                            height: `${(month.amount / Math.max(...metrics.growthTrends.map(m => m.amount))) * 100}%`,
                          }}
                        ></div>
                      ))}
                      {/* Line for average donation */}
                      <div className="absolute left-0 right-0 border-t-2 border-dashed border-purple-500 dark:border-purple-400"
                        style={{
                          bottom: `${(metrics.growthTrends.reduce((acc, month) => acc + month.averageDonation, 0) / metrics.growthTrends.length) / Math.max(...metrics.growthTrends.map(m => m.amount)) * 100}%`,
                        }}
                      ></div>
                    </div>
                  </div>
              ...
              <div className="p-4 border-t border-slate-100 dark:border-gray-700 flex justify-between items-center text-xs">
                <div className="flex items-center">
                  ...
                  <span className="text-slate-600 dark:text-gray-400">Monthly Donation Volume</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-0 border-t-2 border-dashed border-purple-500 dark:border-purple-400 mr-1"></div>
                  <span className="text-slate-600 dark:text-gray-400">Average Donation Size</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="p-4 border-b border-slate-100 dark:border-gray-700">
                <h2 className="text-lg font-medium text-slate-900 dark:text-white">Performance Summary</h2>
              </div>
              <div className="divide-y divide-slate-100 dark:divide-gray-700">
                <div className="p-4">
                  <div className="flex justify-between items-center mb-2">
                    <h3 className="text-sm font-medium text-slate-700 dark:text-gray-300">Growth Rate</h3>
                  ...
                  <p className="text-xs text-slate-500 dark:text-gray-400">
                    Monthly growth in donation volume compared to previous period
                  </p>
                </div>
                
                <div className="p-4">
                  <div className="flex justify-between items-center mb-2">
                    <h3 className="text-sm font-medium text-slate-700 dark:text-gray-300">Campaign Performance</h3>
                    <div className="flex items-center text-emerald-600 dark:text-emerald-400 text-sm">
                ...
                <div className="p-4">
                  <div className="flex justify-between items-center mb-2">
                    <h3 className="text-sm font-medium text-slate-700 dark:text-gray-300">Platform Efficiency</h3>
                    <div className="flex items-center text-emerald-600 dark:text-emerald-400 text-sm">
                ...
                <div className="p-4">
                  <div className="flex justify-between items-center mb-2">
                    <h3 className="text-sm font-medium text-slate-700 dark:text-gray-300">User Engagement</h3>
            ...
            >
              <div className="p-4 border-b border-slate-100 dark:border-gray-700">
                <h2 className="text-lg font-medium text-slate-900 dark:text-white">Industry Benchmarks</h2>
              </div>
              <div className="p-4 border-b border-slate-100 dark:border-gray-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <div className="flex justify-between mb-2">
                      <div className="flex items-center">
                        ...
                        <span className="text-sm text-slate-700 dark:text-gray-300">Your Platform</span>
                      </div>
                      <span className="text-sm font-medium text-slate-900 dark:text-white">
                        {activeBenchmark === 'donation' && `$${metrics.benchmarks.platformAvgDonation}`}
                        {activeBenchmark === 'conversion' && `${metrics.benchmarks.platformConversionRate}%`}
                        {activeBenchmark === 'success' && `${metrics.benchmarks.platformCampaignSuccess}%`}
                        {activeBenchmark === 'retention' && `${metrics.benchmarks.platformDonorRetention}%`}
                      </span>
                    </div>
                    <div className="flex justify-between mb-4">
                      <div className="flex items-center">
                        <div className="w-3 h-3 bg-slate-300 dark:bg-gray-600 rounded-full mr-2"></div>
                        <span className="text-sm text-slate-700 dark:text-gray-300">Industry Average</span>
                      </div>
                      <span className="text-sm font-medium text-slate-900 dark:text-white">
                        {activeBenchmark === 'donation' && `$${metrics.benchmarks.industryAvgDonation}`}
                        {activeBenchmark === 'conversion' && `${metrics.benchmarks.industryConversionRate}%`}
                        {activeBenchmark === 'success' && `${metrics.benchmarks.industryCampaignSuccess}%`}
                        {activeBenchmark === 'retention' && `${metrics.benchmarks.industryDonorRetention}%`}
                      </span>
                    </div>
                    <div className="h-4 bg-slate-100 dark:bg-gray-700 rounded-full overflow-hidden mb-2">
                      <div className="flex h-full">
                        <div 
                          ...
                          style={{ 
                            width: activeBenchmark === 'donation' 
                              ? `${(metrics.benchmarks.platformAvgDonation / (metrics.benchmarks.platformAvgDonation + metrics.benchmarks.industryAvgDonation)) * 100}%`
                              : activeBenchmark === 'conversion'
                              ? `${(metrics.benchmarks.platformConversionRate / (metrics.benchmarks.platformConversionRate + metrics.benchmarks.industryConversionRate)) * 100}%`
                              : activeBenchmark === 'success'
                              ? `${(metrics.benchmarks.platformCampaignSuccess / (metrics.benchmarks.platformCampaignSuccess + metrics.benchmarks.industryCampaignSuccess)) * 100}%`
                              : `${(metrics.benchmarks.platformDonorRetention / (metrics.benchmarks.platformDonorRetention + metrics.benchmarks.industryDonorRetention)) * 100}%`
                          }}
                        ></div>
                        <div 
                          ...
                          style={{ 
                            width: activeBenchmark === 'donation' 
                              ? `${(metrics.benchmarks.industryAvgDonation / (metrics.benchmarks.platformAvgDonation + metrics.benchmarks.industryAvgDonation)) * 100}%`
                              : activeBenchmark === 'conversion'
                              ? `${(metrics.benchmarks.industryConversionRate / (metrics.benchmarks.platformConversionRate + metrics.benchmarks.industryConversionRate)) * 100}%`
                              : activeBenchmark === 'success'
                              ? `${(metrics.benchmarks.industryCampaignSuccess / (metrics.benchmarks.platformCampaignSuccess + metrics.benchmarks.industryCampaignSuccess)) * 100}%`
                              : `${(metrics.benchmarks.industryDonorRetention / (metrics.benchmarks.platformDonorRetention + metrics.benchmarks.industryDonorRetention)) * 100}%`
                          }}
                        ></div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className="text-sm text-slate-700 dark:text-gray-300 font-medium">
                      {activeBenchmark === 'donation' && 'Average Donation Size'}
                      {activeBenchmark === 'conversion' && 'Visitor-to-Donor Conversion Rate'}
                      {activeBenchmark === 'success' && 'Campaign Success Rate'}
                      {activeBenchmark === 'retention' && 'Donor Retention Rate'}
                    </div>
                    <p className="text-xs text-slate-500 dark:text-gray-400">
                      {activeBenchmark === 'donation' && 'Your platform\'s average donation is significantly higher than the industry average, indicating strong donor engagement and effective fundraising strategies.'}
                      {activeBenchmark === 'conversion' && 'Your conversion rate outperforms the industry standard, showing effective campaign pages and donor journeys that successfully convert visitors into contributors.'}
                      {activeBenchmark === 'success' && 'Your platform helps campaigns reach their goals at a higher rate than the industry average, demonstrating the effectiveness of your campaign tools and community.'}
                      {activeBenchmark === 'retention' && 'Your donor retention rate exceeds industry benchmarks, indicating strong donor relationships, effective communication, and meaningful impact reporting.'}
                    </p>
                    <div className="text-xs flex items-center">
                      <Info size={14} className="text-primary-500 mr-1 flex-shrink-0" />
                      <span className="text-slate-600 dark:text-gray-400">
                        {activeBenchmark === 'donation' && 'Data sourced from Fundraising Effectiveness Project Q2 2025 Report'}
                        {activeBenchmark === 'conversion' && 'Data sourced from M+R Benchmarks 2025 Study'}
                        {activeBenchmark === 'success' && 'Data sourced from Crowdfunding Industry Report 2025'}
                        {activeBenchmark === 'retention' && 'Data sourced from Giving USA Foundation 2025 Annual Report'}
                      </span>
                    </div>
                  </div>
                </div>
            ...
            >
              <div className="p-4 border-b border-slate-100 dark:border-gray-700 flex justify-between items-center">
                <h2 className="text-lg font-medium text-slate-900 dark:text-white">Campaign Metrics</h2>
                <div className="flex items-center text-sm text-slate-500 dark:text-gray-400">
                  <Gift size={18} />
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between mb-1">
                      <span className="text-sm text-slate-500 dark:text-gray-400">Average Completion Rate</span>
                      <span className="text-sm font-medium text-slate-900 dark:text-white">{metrics.campaignMetrics.avgCompletionRate}%</span>
                    </div>
                    <div className="w-full h-2 bg-slate-100 dark:bg-gray-700 rounded-full overflow-hidden">
                      <div 
                        className="h-full bg-primary-500 rounded-full"
                        style={{ width: `${metrics.campaignMetrics.avgCompletionRate}%` }}
                      ></div>
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      <span className="text-sm text-slate-500 dark:text-gray-400">Average Time to Goal</span>
                      <span className="text-sm font-medium text-slate-900 dark:text-white">{metrics.campaignMetrics.avgTimeToGoal} days</span>
                    </div>
                    <div className="w-full h-2 bg-slate-100 dark:bg-gray-700 rounded-full overflow-hidden">
                      <div 
                        className="h-full bg-blue-500 rounded-full"
                        style={{ width: `${(metrics.campaignMetrics.avgTimeToGoal / 90) * 100}%` }}
                      ></div>
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      <span className="text-sm text-slate-500 dark:text-gray-400">Average Donors per Campaign</span>
                      <span className="text-sm font-medium text-slate-900 dark:text-white">{metrics.campaignMetrics.avgDonorsPerCampaign}</span>
                    </div>
                    <div className="w-full h-2 bg-slate-100 dark:bg-gray-700 rounded-full overflow-hidden">
                      <div 
                        className="h-full bg-emerald-500 rounded-full"
                        style={{ width: `${(metrics.campaignMetrics.avgDonorsPerCampaign / 100) * 100}%` }}
                      ></div>
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      <span className="text-sm text-slate-500 dark:text-gray-400">Conversion Rate</span>
                      <span className="text-sm font-medium text-slate-900 dark:text-white">{metrics.campaignMetrics.campaignViewsToConversion}%</span>
                    </div>
                    <div className="w-full h-2 bg-slate-100 dark:bg-gray-700 rounded-full overflow-hidden">
                      <div 
                        className="h-full bg-amber-500 rounded-full"
                        style={{ width: `${(metrics.campaignMetrics.campaignViewsToConversion / 10) * 100}%` }}
                      ></div>
                    </div>
                  </div>
                </div>
            ...
            >
              <div className="p-4 border-b border-slate-100 dark:border-gray-700 flex justify-between items-center">
                <h2 className="text-lg font-medium text-slate-900 dark:text-white">Engagement Metrics</h2>
                <div className="flex items-center text-sm text-slate-500 dark:text-gray-400">
                  <Activity size={18} />
                </div>
              </div>
              <div className="p-4">
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between mb-1">
                      <span className="text-sm text-slate-500 dark:text-gray-400">Average Time on Page</span>
                      <span className="text-sm font-medium text-slate-900 dark:text-white">{metrics.engagementMetrics.avgTimeOnPage} minutes</span>
                    </div>
                    <div className="w-full h-2 bg-slate-100 dark:bg-gray-700 rounded-full overflow-hidden">
                      <div 
                        className="h-full bg-primary-500 rounded-full"
                        style={{ width: `${(metrics.engagementMetrics.avgTimeOnPage / 5) * 100}%` }}
                      ></div>
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      <span className="text-sm text-slate-500 dark:text-gray-400">Bounce Rate</span>
                      <span className="text-sm font-medium text-slate-900 dark:text-white">{metrics.engagementMetrics.bounceRate}%</span>
                    </div>
                    <div className="w-full h-2 bg-slate-100 dark:bg-gray-700 rounded-full overflow-hidden">
                      <div 
                        className="h-full bg-red-500 rounded-full"
                        style={{ width: `${metrics.engagementMetrics.bounceRate}%` }}
                      ></div>
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      <span className="text-sm text-slate-500 dark:text-gray-400">Social Share Rate</span>
                      <span className="text-sm font-medium text-slate-900 dark:text-white">{metrics.engagementMetrics.socialShareClickRate}%</span>
                    </div>
                    <div className="w-full h-2 bg-slate-100 dark:bg-gray-700 rounded-full overflow-hidden">
                      <div 
                        className="h-full bg-purple-500 rounded-full"
                        style={{ width: `${(metrics.engagementMetrics.socialShareClickRate / 10) * 100}%` }}
                      ></div>
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      <span className="text-sm text-slate-500 dark:text-gray-400">Mobile Usage</span>
                      <span className="text-sm font-medium text-slate-900 dark:text-white">{metrics.engagementMetrics.mobileUsage}%</span>
                    </div>
                    <div className="w-full h-2 bg-slate-100 dark:bg-gray-700 rounded-full overflow-hidden">
                      <div 
                        className="h-full bg-blue-500 rounded-full"
                        style={{ width: `${metrics.engagementMetrics.mobileUsage}%` }}
                      ></div>
                    </div>
                  </div>
                </div>
            ...
            >
              <div className="p-4 border-b border-slate-100 dark:border-gray-700">
                <h2 className="text-lg font-medium text-slate-900 dark:text-white">Platform Health</h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-slate-100 dark:divide-gray-700">
                <div className="p-4">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-slate-500 dark:text-gray-400">System Uptime</p>
                  </div>
                </div>
                ...
                <div className="p-4">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-slate-500 dark:text-gray-400">Page Load Time</p>
                  </div>
                </div>
                ...
                <div className="p-4">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-slate-500 dark:text-gray-400">API Response Time</p>
                  </div>
                </div>
                ...
                <div className="p-4">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-slate-500 dark:text-gray-400">Error Rate</p>
                  </div>
                </div>
              </div>
            </motion.div>
        ...
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-800 text-red-800 dark:text-red-400 px-4 py-3 rounded-lg mb-6 flex items-center">
          ...
          <span>Failed to load performance metrics. Please try again later.</span>
        </div>
      )}
    </div>
  );
