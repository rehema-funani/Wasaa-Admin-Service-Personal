...
const BusinessSettingsPage = () => {
  ...
  const [settings, setSettings] = useState({
    ...
    requiredDocuments: ["businessRegistration", "taxCertificate", "ownerIdentification"],
    registrationFee: 0,
  ...
  const documentOptions = [
    { value: "businessRegistration", label: "Business Registration Certificate" },
      ...
      <div className="relative inline-block w-12 align-middle select-none">
        ...
        <label
          ...
          className={`block overflow-hidden h-6 rounded-full cursor-pointer transition-colors duration-200 ease-in-out ${
            settings[field] ? "bg-blue-600 dark:bg-blue-500" : "bg-gray-300 dark:bg-gray-600"
          }`}
        >
          <span
  ...
  const renderNumberSetting = (field, label, description, min = 0, max = null, unit = null) => (
    <div className="flex items-center justify-between py-3 border-b border-gray-100 dark:border-gray-700">
      <div>
        <p className="font-medium text-gray-700 dark:text-gray-300">{label}</p>
        <p className="text-sm text-gray-500 dark:text-gray-400">{description}</p>
              ...
              {expandedSections.registration && (
                <div className="mt-4 space-y-1">
                  ...
                  <div className="py-3 border-b border-gray-100 dark:border-gray-700">
                    <div className="mb-2">
                      <p className="font-medium text-gray-700 dark:text-gray-300">Required Documents</p>
                      <p className="text-sm text-gray-500 dark:text-gray-400">Documents required for business registration</p>
                    </div>
                      ...
                      {documentOptions.map(doc => (
                        <label key={doc.value} className="flex items-center">
                          <input
                            ...
                            checked={settings.requiredDocuments.includes(doc.value)}
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-white/20 dark:border-gray-700 shadow-sm">
              ...
              {expandedSections.limits && (
                <div className="mt-4 space-y-1">
                  ...
                  <div className="py-3 border-b border-gray-100 dark:border-gray-700">
                    <div className="mb-2">
                      <p className="font-medium text-gray-700 dark:text-gray-300">Restricted Product Categories</p>
                        ...
                        >
                          ...
                          <button
                            ...
                            onClick={() => {
                              setSettings({
                                ...settings,
                                restrictedProductCategories: settings.restrictedProductCategories.filter(c => c !== category)
                              });
                            }}
                          >
                            <X size={14} />
                        ...
                        <input
                          ...
                          onKeyDown={(e) => {
                            if (e.key === 'Enter' && e.target.value.trim()) {
                              setSettings({
                                ...settings,
                                restrictedProductCategories: [...settings.restrictedProductCategories, e.target.value.trim()]
                              });
                              e.target.value = '';
                            }
                          }}
