  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        setError('Failed to fetch SLA rule or categories');
        console.error(err);
      } finally {
    ...
    return (
      <div className="flex justify-center items-center h-screen bg-gray-50">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-500">Loading SLA rule...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white shadow-sm rounded-lg overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200">
            <h1 className="text-xl font-semibold text-gray-900">Edit SLA Rule</h1>
            <p className="mt-1 text-sm text-gray-500">
              Update service level agreement settings
            </p>
          </div>
