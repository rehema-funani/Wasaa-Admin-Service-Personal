    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-8 flex justify-center items-center">
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-8 text-center">
            <p className="text-gray-500 dark:text-gray-400">FAQ not found</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden mb-6">
          ...
          <div className="border-b border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-center mb-4">
              ...
              >
                <User
                  className="h-5 w-5"
                  style={{ color: faq.category.color }}
                />
              </div>
              <span
          ...
          <div className="bg-gray-50 dark:bg-gray-700 px-6 py-4 border-t border-gray-200 dark:border-gray-600">
            <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
              ...
              <div className="flex items-center space-x-2">
                <button
                  onClick={handlePrint}
                  className="p-1.5 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-600 hover:text-gray-700 dark:hover:text-gray-300"
          ...
          <div className="p-6 border-t border-gray-200 dark:border-gray-700">
            ...
            {feedbackSuccess && (
              <div className="mb-4 p-3 bg-green-50 dark:bg-green-900/20 border border-green-100 dark:border-green-700 rounded-md text-sm text-green-800 dark:text-green-300">
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                className={`inline-flex items-center px-3 py-1.5 border rounded-md text-sm ${
                  ...
                  (userFeedback !== null || submittingFeedback) &&
                  userFeedback !== true
            ...
            {userFeedback === false && (
              <div className="mt-4">
                <button className="inline-flex items-center text-sm text-teal-600 dark:text-teal-400 hover:text-teal-800 dark:hover:text-teal-300">
