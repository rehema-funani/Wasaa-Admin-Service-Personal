...
const ReportsDashboard = () => {
  ...
  const [reportTypes] = useState([
    { id: 'TICKET_SUMMARY', name: 'Ticket Summary', description: 'Overview of all tickets in the specified time period', icon: FileBarChart },
    { id: 'AGENT_PERFORMANCE', name: 'Agent Performance', description: 'Performance metrics for support agents', icon: PieChart },
    { id: 'CUSTOMER_SATISFACTION', name: 'Customer Satisfaction', description: 'Customer satisfaction scores and feedback', icon: FilePlus },
    { id: 'RESPONSE_TIMES', name: 'Response Times', description: 'Analysis of response and resolution times', icon: FileMinus }
  ]);
  ...
  const fetchQuickStats = async () => {
    try {
      ...
      if (response.success && response.data && response.data.stats) {
        ...
        const resolvedTickets = stats.tickets.byStatus.find(
  ...
  const generateReport = async () => {
    ...
    const formattedData = {
      ...
      dateRange: {
        ...
        end: new Date(reportForm.dateRange.end + 'T23:59:59.999Z').toISOString()
      }
    };
    ...
    try {
      ...
      setReportSuccess('Report generation started. It will appear in the list when ready.');
    ...
    <div className="min-h-screen bg-gray-50 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-1 text-sm text-gray-500">Generate and view reports for your support activities</p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <p className="text-sm font-medium text-gray-500">Tickets Created</p>
                    <p className="text-2xl font-bold text-gray-900">{quickStats.ticketsCreated}</p>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div className="flex items-start">
                  <div className="p-2 bg-green-50 rounded-lg">
                    <FileMinus className="h-6 w-6 text-green-500" />
                  </div>
                  <div className="ml-3">
                    <p className="text-sm font-medium text-gray-500">Tickets Closed</p>
                    <p className="text-2xl font-bold text-gray-900">{quickStats.ticketsClosed}</p>
                    <p className="text-xs text-gray-500 mt-1">Last 7 days</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-2xl font-bold text-gray-900">{formatDuration(quickStats.avgResponseTime)}</p>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-2xl font-bold text-gray-900">{quickStats.customerSatisfaction}%</p>
                    <p className="text-xs text-gray-500 mt-1">All tickets</p>
                  </div>
                </div>
              </div>
        ...
        <div className="mb-8">
          <h2 className="text-lg font-medium text-gray-800 mb-4">Generate New Report</h2>

          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div className="p-5 border-b border-gray-200">
              <div className="flex items-center">
                <BarChart className="h-5 w-5 text-gray-400 mr-2" />
                <h3 className="text-base font-medium text-gray-800">Create Custom Report</h3>
              </div>
            </div>
            ...
            {reportError && (
              <div className="mx-5 mt-5">
                <div className="p-4 rounded-xl bg-red-50 border-l-4 border-red-500 flex items-start">
            ...
            {reportSuccess && (
              <div className="mx-5 mt-5">
                <div className="p-4 rounded-xl bg-green-50 border-l-4 border-green-500 flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-3 mt-0.5" />
                  <p className="text-sm text-green-700">{reportSuccess}</p>
                  <button onClick={() => setReportSuccess(null)} className="ml-auto">
            ...
            <div className="p-5">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="block w-full px-3 py-2.5 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
                  >
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={(e) => handleReportFormChange('dateRange.start', e.target.value)}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={(e) => handleReportFormChange('dateRange.end', e.target.value)}
                          className="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
                        />
                      </div>
                    </div>
              ...
              <div className="mt-6 flex justify-end">
                <button
                  ...
                  className="px-4 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-teal-500 hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 disabled:opacity-70 disabled:cursor-not-allowed flex items-center"
                >
                  {generatingReport ? (
                    <>
              ...
              <div className="flex flex-col items-center justify-center h-64 text-center p-6">
                ...
                {(reportFilters.type || reportFilters.status) && (
                  <button
                    ...
                    className="mt-4 px-4 py-2 text-sm font-medium text-teal-600 hover:text-teal-700 flex items-center"
                  >
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center">
                                <div className="flex-shrink-0 h-10 w-10 flex items-center justify-center rounded-md bg-gray-100">
                                  <ReportIcon className="h-6 w-6 text-gray-600" />
                                </div>
                                <div className="ml-4">
                              ...
                              {report.status === 'COMPLETED' ? (
                                ...
                                <button
                                  onClick={() => {
                                    ...
                                    document.querySelector('#reportType').scrollIntoView({ behavior: 'smooth' });
                                  }}
