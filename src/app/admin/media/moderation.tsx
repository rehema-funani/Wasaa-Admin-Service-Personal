...
import { shortsService } from '../../../api/services/shorts';
...
const VideoModeration: React.FC = () => {
  ...
  const fetchPendingModerations = async () => {
    try {
      const response = await shortsService.pendingModShorts();
