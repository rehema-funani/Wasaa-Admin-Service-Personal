...
const CreatorDetail: React.FC = () => {
    ...
    return (
        <div className="p-6">
            <div className="mb-6">
                <Link to="/admin/media/shorts/creators" className="inline-flex items-center text-primary-600 hover:text-primary-800">
                            ...
                            <div className="space-y-3">
                                <button className="w-full flex items-center justify-between px-4 py-2 bg-gray-50 hover:bg-gray-100 rounded-lg text-sm">
                                    <span className="flex items-center">
                                        <Bell size={16} className="mr-2 text-primary-600" />
                                        Send Warning
                                    </span>
