...
const SlimSidebar: React.FC = () => {
    ...
    return (
      <div
        className={`flex flex-col h-full bg-gradient-to-b from-slate-900 to-primary-900 dark:from-charcoal-950 dark:to-dark-surface transition-all duration-300 z-50 shadow-xl dark:shadow-dark-lg ${
          isExpanded ? "w-64" : "w-[65px]"
        }`}
        ...
        >
            ...
            <div className="flex items-center">
              ...
              {isExpanded && (
                <div className="ml-3 animate-fadeIn">
                  ...
                  <div className="flex items-center">
                    <span
                      className={`w-1.5 h-1.5 rounded-full ${securityLevel.color} mr-1.5`}
                    ></span>
          ...
          {isExpanded && (
            <div className="bg-slate-800/60 dark:bg-dark-elevated/60 rounded-lg p-2.5 flex justify-between items-center mb-2">
              ...
              <span className="text-xs font-mono font-medium text-slate-200 dark:text-slate-300">
                {formatTime()}
              </span>
            </div>
          )}
          ...
          <div className="flex-1 space-y-1 py-1">
            ...
            >
              ...
              >
                <Shield
                  size={20}
                  strokeWidth={isActive("/admin/logs") ? 2 : 1.5}
                />
            ...
            >
              ...
              >
                <BarChart3
                  size={20}
                  strokeWidth={isActive("/admin/finance/reports") ? 2 : 1.5}
                />
              </div>
              {isExpanded && (
                <div className="ml-3 flex items-center justify-between flex-1 animate-fadeIn">
            ...
            >
              ...
              >
                <UserCheck
                  size={20}
                  strokeWidth={isActive("/accounts/profile") ? 2 : 1.5}
                />
              </div>
              {isExpanded && (
                <div className="ml-3 flex items-center justify-between flex-1 animate-fadeIn">
            ...
            >
              ...
              >
                <Settings
                  size={20}
                  strokeWidth={isActive("/admin/settings") ? 2 : 1.5}
                />
              </div>
              {isExpanded && (
                <div className="ml-3 flex items-center justify-between flex-1 animate-fadeIn">
          ...
          <div className="mt-auto pt-3 border-t border-slate-700/50 dark:border-dark-border/50">
            <button onClick={() => handleLogout} className="w-full flex items-center p-3 rounded-xl text-red-300 dark:text-red-400 hover:text-white hover:bg-red-600/30 dark:hover:bg-red-900/30 transition-all duration-200 group">
              <LogOut size={20} />
              {isExpanded && (
          ...
          {isExpanded && (
            <div className="pt-2 flex items-center justify-between">
              <div className="flex items-center">
                <Database
                  size={12}
                  className="text-slate-500 dark:text-slate-600 mr-1.5"
                />
