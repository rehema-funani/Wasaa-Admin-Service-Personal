          ...
          {data.map((entity, index) => (
            ...
            >
              <div className="flex items-center p-4">
                {/* Entity Avatar */}
                <div
                  className={`w-10 h-10 rounded-xl ${getGradientBackground(
                    entity.id
                  )} flex items-center justify-center mr-3 shrink-0 shadow-sm`}
                >
                ...
                <div className="ml-3 text-right">
                  <div
                    className={`px-2 py-1 rounded-full text-xs ${getActivityBadgeColor(
                      entity.time
                    )} inline-block mb-1`}
                  >
                    {entity.activity}
