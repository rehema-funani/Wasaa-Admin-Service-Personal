    ...
    <div className="space-y-4 p-1">
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-700">
                You are editing an AML rule. Changes may affect detection
                patterns and alerts.
              </p>
            </div>
          </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-primary-700">
                You are creating a new AML rule. The rule will be set to
                inactive by default until you activate it.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gray-50 p-4 rounded-lg">
        ...
        <p className="text-sm text-gray-500 mb-3">
          In a complete implementation, include interfaces for configuring:
        </p>
