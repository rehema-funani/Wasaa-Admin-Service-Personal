...
const mediaRoutes = [
  ...
  { path: PATHS.ADMIN.MEDIA.SHORTS.REPORTS, element: MediaModule.ReportsPage, permissions: PermissionMap.ViewReported },
  { path: PATHS.ADMIN.MEDIA.SHORTS.REPORT_DETAIL, element: MediaModule.ReportsPage, permissions: PermissionMap.ViewReported },
  { path: PATHS.ADMIN.MEDIA.SHORTS.COMMENTS, element: MediaModule.CommentsPage, permissions: PermissionMap.Media.view },
  { path: PATHS.ADMIN.MEDIA.SHORTS.COMMENTS_VIDEO, element: MediaModule.CommentsPage, permissions: PermissionMap.Media.view },
  { path: PATHS.ADMIN.MEDIA.SHORTS.HASHTAGS, element: MediaModule.HashtagsPage, permissions: PermissionMap.Media.view },
  { path: PATHS.ADMIN.MEDIA.SHORTS.HASHTAGS_BLOCKED, element: MediaModule.HashtagsPage, permissions: PermissionMap.Media.view },
  { path: PATHS.ADMIN.MEDIA.SHORTS.HASHTAGS_TRENDING, element: MediaModule.HashtagsPage, permissions: PermissionMap.Media.view },
  { path: PATHS.ADMIN.MEDIA.SHORTS.CREATORS, element: MediaModule.CreatorsPage, permissions: PermissionMap.Media.view },
  { path: PATHS.ADMIN.MEDIA.SHORTS.CREATOR_DETAIL, element: MediaModule.CreatorDetail, permissions: PermissionMap.Media.view },
  { path: PATHS.ADMIN.MEDIA.SHORTS.PROMOTION, element: MediaModule.PromotionPage, permissions: PermissionMap.Media.view },
  { path: PATHS.ADMIN.MEDIA.SHORTS.PROMOTION_TRENDING, element: MediaModule.PromotionPage, permissions: PermissionMap.Media.view },
  { path: PATHS.ADMIN.MEDIA.SHORTS.PROMOTION_FEATURED, element: MediaModule.PromotionPage, permissions: PermissionMap.Media.view },
  { path: PATHS.ADMIN.MEDIA.SHORTS.ANALYTICS, element: MediaModule.AnalyticsPage, permissions: PermissionMap.Media.view },
  { path: PATHS.ADMIN.MEDIA.SHORTS.ANALYTICS_VIDEOS, element: MediaModule.AnalyticsPage, permissions: PermissionMap.Media.view },
  { path: PATHS.ADMIN.MEDIA.SHORTS.ANALYTICS_MODERATION, element: MediaModule.AnalyticsPage, permissions: PermissionMap.Media.view },
